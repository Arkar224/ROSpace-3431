...
class WaypointNavigator(Node):
    ...
    def __init__(self):
        ...
        # Setting parameters if not present
        if not self.has_parameter('use_sim_time'):
            self.declare_parameter('use_sim_time', False)
        if not self.has_parameter('map'):
            self.declare_parameter('map', '')
        if not self.has_parameter('waypoints_file'):
            self.declare_parameter('waypoints_file', '')
        if not self.has_parameter('params_file'):
        ...
        self.get_logger().info(f"params_file: {self.params_file}")
...
def main():
    ...
    waypoint_navigator.waypoint_navigation()
